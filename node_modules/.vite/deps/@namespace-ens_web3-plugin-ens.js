import {
  require_commonjs10 as require_commonjs2,
  require_commonjs4 as require_commonjs,
  require_hmac,
  require_md,
  require_sha256,
  require_sha3,
    ...
    async function getWebSocketRpcClient(url, options = {}) {
      ...
      return (0, socket_js_1.getSocketRpcClient)({
        async getSocket({ onClose, onError, onOpen, onResponse }) {
          const WebSocket3 = await Promise.resolve().then(() => (init_native(), __toCommonJS(native_exports))).then((module2) => module2.WebSocket);
...
// node_modules/@namespace-ens/web3-plugin-ens/dist/abi/eth-controller.json
var require_eth_controller = __commonJS({
  "node_modules/@namespace-ens/web3-plugin-ens/dist/abi/eth-controller.json"(exports, module) {
    module.exports = [
      {
        inputs: [
          {
...
// node_modules/@namespace-ens/web3-plugin-ens/dist/ens-contracts/controller.js
var require_controller = __commonJS({
  "node_modules/@namespace-ens/web3-plugin-ens/dist/ens-contracts/controller.js"(exports) {
    "use strict";
    ...
    var web3_1 = require_commonjs2();
    var web3_eth_accounts_1 = require_commonjs();
    var eth_controller_json_1 = __importDefault(require_eth_controller());
    var EnsController = class _EnsController {
      constructor() {
      }
      static create(chain) {
        if (chain != web3_eth_accounts_1.Chain.Mainnet && chain != web3_eth_accounts_1.Chain.Sepolia)
          throw new Error("Invalid chain");
        const address = chain == web3_eth_accounts_1.Chain.Mainnet ? _EnsController.CONTROLLER_ADDRESS_MAINNET : _EnsController.CONTROLLER_ADDRESS_SEPOLIA;
        _EnsController._contract = new web3_1.Contract(eth_controller_json_1.default, address);
        _EnsController._controller = new _EnsController();
      }
      static get instance() {
        return _EnsController._controller;
      }
      get contract() {
        return _EnsController._contract;
      }
      async commit(req) {
        var _a, _b;
        const label = req.label.toLocaleLowerCase();
        const regData = await this.encodeSetAddr(`${label}.eth`, req.owner);
        const encodedSecret = (0, viem_1.toHex)(req.secret, { size: 32 });
        const commitment = await this.contract.methods.makeCommitment(label, req.owner, req.durationInSeconds, encodedSecret, req.resolver, [regData], req.setAsPrimary, req.fuses).call();
        const web3 = new web3_1.Web3(this.contract.provider);
        const acct = (_b = (_a = this.contract.wallet) == null ? void 0 : _a[0]) == null ? void 0 : _b.address;
      ...
      async register(req) {
        ...
        const accts = await web3.eth.getAccounts();
        const from = acct ?? accts[0];
        return await this.contract.methods.register(label, req.owner, req.durationInSeconds, encodedSecret, req.resolver, [regData], req.setAsPrimary, req.fuses).send({
          from,
          value
        });
      }
      async estimatePrice(label, durationInSeconds) {
        const estimate = await this.contract.methods.rentPrice(label, durationInSeconds).call();
        return estimate.base + estimate.premium;
      }
      async encodeSetAddr(name, registrant) {
        const web3 = new web3_1.Web3(this.contract.provider);
        ...
        }, [(0, viem_1.namehash)(name), registrant]);
      }
    };
    exports.EnsController = EnsController;
    EnsController.CONTROLLER_ADDRESS_MAINNET = "0x253553366da8546fc250f225fe3d25d0c782303b";
    EnsController.CONTROLLER_ADDRESS_SEPOLIA = "0xFED6a969AaA60E4961FCD3EBF1A2e8913ac65B72";
  }
});

// node_modules/@namespace-ens/web3-plugin-ens/dist/abi/public-resolver.json
var require_public_resolver = __commonJS({
  "node_modules/@namespace-ens/web3-plugin-ens/dist/abi/public-resolver.json"(exports, module) {
    module.exports = [
      {
        inputs: [
          {
...
// node_modules/@namespace-ens/web3-plugin-ens/dist/ens-contracts/resolver.js
var require_resolver = __commonJS({
  "node_modules/@namespace-ens/web3-plugin-ens/dist/ens-contracts/resolver.js"(exports) {
    "use strict";
    ...
    var viem_1 = require_cjs();
    var web3_1 = __importStar(require_commonjs2());
    var web3_eth_accounts_1 = require_commonjs();
    var public_resolver_json_1 = __importDefault(require_public_resolver());
    var Resolver = class _Resolver {
      ...
      static create(chain) {
        if (chain != web3_eth_accounts_1.Chain.Mainnet && chain != web3_eth_accounts_1.Chain.Sepolia)
          throw new Error("Invalid chain");
        const address = chain == web3_eth_accounts_1.Chain.Mainnet ? _Resolver.RESOLVER_ADDRESS_MAINNET : _Resolver.RESOLVER_ADDRESS_SEPOLIA;
        _Resolver._contract = new web3_1.Contract(public_resolver_json_1.default, address);
        _Resolver._resolver = new _Resolver();
      }
      static get instance() {
        return _Resolver._resolver;
      }
      get contract() {
        return _Resolver._contract;
      }
      async setTextRecords(name, recordsToUpdate, recordsToRemove) {
        var _a, _b;
        name = name.toLowerCase();
        const nameNode = (0, viem_1.namehash)(name);
        const web3 = new web3_1.default(this.contract.provider);
        const acct = (_b = (_a = this.contract.wallet) == null ? void 0 : _a[0]) == null ? void 0 : _b.address;
        const accts = await web3.eth.getAccounts();
        const from = acct ?? accts[0];
        const setTextFn = public_resolver_json_1.default.find((abi) => abi.name === "setText");
        const encode = (key, value) => web3.eth.abi.encodeFunctionCall(setTextFn, [nameNode, key, value]);
        const updated = recordsToUpdate == null ? void 0 : recordsToUpdate.map((record) => encode(record.key, record.value));
        const removed = recordsToRemove == null ? void 0 : recordsToRemove.map((record) => encode(record, ""));
        return await this.contract.methods.multicall([...updated, ...removed]).send({
          from
        });
      }
      async getTextRecords(name, recordKeys) {
        name = name.toLowerCase();
        const nameNode = (0, viem_1.namehash)(name);
        const web3 = new web3_1.default(this.contract.provider);
        const textFn = public_resolver_json_1.default.find((abi) => abi.name === "text");
        const encode = (key) => web3.eth.abi.encodeFunctionCall(textFn, [nameNode, key]);
        const keys = recordKeys == null ? void 0 : recordKeys.map((key) => encode(key));
        const records = await this.contract.methods.multicall(keys).call();
        const decode = (record) => web3.eth.abi.decodeParameters(["string"], record);
        return records == null ? void 0 : records.map((record) => decode(record)).map((record, index) => {
      ...
      async setAddress(name, address) {
        ...
        const accts = await web3.eth.getAccounts();
        const from = acct ?? accts[0];
        return await this.contract.methods.setAddr((0, viem_1.namehash)(name.toLowerCase()), address).send({ from });
      }
      async getAddress(name) {
        return await this.contract.methods.addr((0, viem_1.namehash)(name.toLowerCase())).call();
      }
      async getName(node) {
    ...
    Resolver.RESOLVER_ADDRESS_MAINNET = "0x231b0Ee14048e9dCcD1d247744d114a4EB5E8E63";
    Resolver.RESOLVER_ADDRESS_SEPOLIA = "0x8FADE66B79cC9f707aB26799354482EB93a5B7dD";
  }
});

// node_modules/@namespace-ens/web3-plugin-ens/dist/abi/reverse-registrar.json
var require_reverse_registrar = __commonJS({
  "node_modules/@namespace-ens/web3-plugin-ens/dist/abi/reverse-registrar.json"(exports, module) {
    module.exports = [
      {
...
// node_modules/@namespace-ens/web3-plugin-ens/dist/ens-contracts/reverse-registrar.js
var require_reverse_registrar2 = __commonJS({
  "node_modules/@namespace-ens/web3-plugin-ens/dist/ens-contracts/reverse-registrar.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var web3_1 = __importStar(require_commonjs2());
    var web3_eth_accounts_1 = require_commonjs();
    var reverse_registrar_json_1 = __importDefault(require_reverse_registrar());
    var ReverseRegistrar = class _ReverseRegistrar {
      constructor() {
      }
      static create(chain) {
        if (chain != web3_eth_accounts_1.Chain.Mainnet && chain != web3_eth_accounts_1.Chain.Sepolia)
          throw new Error("Invalid chain");
        const address = chain == web3_eth_accounts_1.Chain.Mainnet ? _ReverseRegistrar.REVERSE_REGISTRAR_ADDRESS_MAINNET : _ReverseRegistrar.REVERSE_REGISTRAR_ADDRESS_SEPOLIA;
        _ReverseRegistrar._contract = new web3_1.Contract(reverse_registrar_json_1.default, address);
        _ReverseRegistrar._resolver = new _ReverseRegistrar();
      }
      static get instance() {
        return _ReverseRegistrar._resolver;
      }
      get contract() {
        return _ReverseRegistrar._contract;
      }
      async node(address) {
      ...
      async setNameForAddr(address, owner, resolver, name) {
        var _a, _b;
        const web3 = new web3_1.default(this.contract.provider);
        const acct = (_b = (_a = this.contract.wallet) == null ? void 0 : _a[0]) == null ? void 0 : _b.address;
        const accts = await web3.eth.getAccounts();
    ...
    exports.ReverseRegistrar = ReverseRegistrar;
    ReverseRegistrar.REVERSE_REGISTRAR_ADDRESS_MAINNET = "0xa58e81fe9b61b5c3fe2afd33cf304c454abfc7cb";
    ReverseRegistrar.REVERSE_REGISTRAR_ADDRESS_SEPOLIA = "0xA0a1AbcDAe1a2a4A2EF8e9113Ff0e02DD81DC0C6";
  }
});

// node_modules/@namespace-ens/web3-plugin-ens/dist/ens-plugin.js
var require_ens_plugin = __commonJS({
  "node_modules/@namespace-ens/web3-plugin-ens/dist/ens-plugin.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.EnsPlugin = void 0;
    var web3_1 = require_commonjs2();
    var controller_1 = require_controller();
    var resolver_1 = require_resolver();
    var reverse_registrar_1 = require_reverse_registrar2();
    var EnsPlugin = class extends web3_1.Web3EthPluginBase {
      constructor(chain) {
        super();
        this.pluginNamespace = "ens";
        controller_1.EnsController.create(chain);
        resolver_1.Resolver.create(chain);
        reverse_registrar_1.ReverseRegistrar.create(chain);
      }
      link(parentContext) {
        super.link(parentContext);
        controller_1.EnsController.instance.contract.link(parentContext);
        resolver_1.Resolver.instance.contract.link(parentContext);
        reverse_registrar_1.ReverseRegistrar.instance.contract.link(parentContext);
      }
      async commit(request) {
        return await controller_1.EnsController.instance.commit(request);
      }
      async registerEnsDomain(request) {
        return await controller_1.EnsController.instance.register(request);
      }
      async setTextRecords(name, recordsToUpdate, recordsToRemove) {
        return await resolver_1.Resolver.instance.setTextRecords(name, recordsToUpdate, recordsToRemove);
      }
      async getTextRecords(name, recordKeys) {
        return await resolver_1.Resolver.instance.getTextRecords(name, recordKeys);
      }
      async setAddress(name, address) {
        return await resolver_1.Resolver.instance.setAddress(name, address);
      }
      async getAddress(name) {
        return await resolver_1.Resolver.instance.getAddress(name);
      }
      async getName(node) {
        return await resolver_1.Resolver.instance.getName(node);
      }
      async setName(name) {
        return await reverse_registrar_1.ReverseRegistrar.instance.setName(name);
      }
      async setNameForAddr(address, owner, resolver, name) {
        return await reverse_registrar_1.ReverseRegistrar.instance.setNameForAddr(address, owner, resolver, name);
      }
      async node(address) {
        return await reverse_registrar_1.ReverseRegistrar.instance.node(address);
      }
    };
...
// node_modules/@namespace-ens/web3-plugin-ens/dist/index.js
var require_dist = __commonJS({
  "node_modules/@namespace-ens/web3-plugin-ens/dist/index.js"(exports) {
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
      if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) {
    ...
    var web3_eth_accounts_1 = require_commonjs();
    Object.defineProperty(exports, "Chain", { enumerable: true, get: function() {
      return web3_eth_accounts_1.Chain;
    } });
    __exportStar(require_ens_plugin(), exports);
  }
});
...
@noble/curves/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=@namespace-ens_web3-plugin-ens.js.map
